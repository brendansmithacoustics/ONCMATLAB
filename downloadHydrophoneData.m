...
if fullDuration > days(1)
    dateVector = startDate_dt:days(1):endDate_dt; % create date vector with monthly resolution, this can be modified into different resolutions, for example days(1) instead of calmonths(1)
